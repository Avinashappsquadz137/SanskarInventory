...
//    var newMiscellaneousItems: [Product] = []
...
//        let totalItems = (data?.products.count ?? 0) + (data?.products.count ?? 0) + newMiscellaneousItems.count + inventoryItems.count
...
//        return (data?.products.count ?? 0) + (data?.products.count ?? 0) + newMiscellaneousItems.count + inventoryItems.count
//    }
//
//    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
//        if indexPath.row < (data?.products.count ?? 0) {
//            let cell = itemtable.dequeueReusableCell(withIdentifier: "misscealaneouscell", for: indexPath) as! misscealaneouscell
//            let misProduct = data?.products[indexPath.row]
...
//            return cell
//        } else if indexPath.row < (data?.products.count ?? 0) + newMiscellaneousItems.count {
//            let newIndex = indexPath.row - (data?.products.count ?? 0)
//            let cell = itemtable.dequeueReusableCell(withIdentifier: "misscealaneouscell", for: indexPath) as! misscealaneouscell
...
//            cell.deletebtn.addTarget(self, action: #selector(deleteButtonTapped(_:)), for: .touchUpInside)
//            return cell
//        } else if indexPath.row < (data?.products.count ?? 0) + newMiscellaneousItems.count + inventoryItems.count {
//            let inventoryIndex = indexPath.row - (data?.products.count ?? 0) - newMiscellaneousItems.count
//            let cell = itemtable.dequeueReusableCell(withIdentifier: "misscealaneouscell", for: indexPath) as! misscealaneouscell
...
//            return cell
//        } else {
//            let productIndex = indexPath.row - (data?.products.count ?? 0) - newMiscellaneousItems.count - inventoryItems.count
...
//        if index < (data?.products.count ?? 0) {
//            data?.products?.remove(at: index)
//        } else if index < (data?.products.count ?? 0) + newMiscellaneousItems.count {
//            let newIndex = index - (data?.products.count ?? 0)
//            newMiscellaneousItems.remove(at: newIndex)
//        } else if index < (data?.products.count ?? 0) + newMiscellaneousItems.count + inventoryItems.count {
//            let inventoryIndex = index - (data?.products.count ?? 0) - newMiscellaneousItems.count
//            inventoryItems.remove(at: inventoryIndex)
//        } else {
//            let productIndex = index - (data?.products.count ?? 0) - newMiscellaneousItems.count - inventoryItems.count
